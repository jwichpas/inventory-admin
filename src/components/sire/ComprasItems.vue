        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel
              ...
              <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100 border-b pb-2">
              ...
              <div class="mt-4 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <h4 class="font-semibold text-gray-700 dark:text-gray-200">Información General</h4>
                  ...
                  <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <h4 class="font-semibold text-gray-700 dark:text-gray-200">Documento</h4>
                    <div class="mt-2 space-y-1 text-sm">
                      <p class="text-gray-600 dark:text-gray-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <h4 class="font-semibold text-gray-700 dark:text-gray-200">Totales</h4>
                    <div class="mt-2 space-y-1 text-sm">
                      <p class="text-gray-600 dark:text-gray-300">
                  ...
                  <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <h4 class="font-semibold text-gray-700 dark:text-gray-200">Estado</h4>
                    <div class="mt-2">
                  ...
                  <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <h4 class="font-semibold text-gray-700 dark:text-gray-200">Fechas</h4>
                    <div class="mt-2 space-y-1 text-sm">
                      <p class="text-gray-600 dark:text-gray-300">
                ...
                <div v-if="compra?.items?.length" class="mt-6">
                  <h4 class="font-semibold text-gray-700 dark:text-gray-200 mb-3">Items</h4>
                  <div class="overflow-x-auto table-fixed ">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                      <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                          <th
                            class="px-4 py-3 text-left text-xs text-ellipsis font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                            Descripción</th>
                          <th
                      ...
                      <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        <tr v-for="(item, index) in compra.items" :key="index">
                          <td class="px-4 py-4 text-sm max-w-xs text-gray-900 dark:text-gray-200">
                            {{ item.description }}
                            <div v-if="item.itemClassCode"
                              class="text-xs text-ellipsis text-gray-500 dark:text-gray-400 mt-1">
